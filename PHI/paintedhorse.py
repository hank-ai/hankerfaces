...
class PaintedHorseInterface():
    ...
    def loadPaintedSpec(self, xlsfilepath, sheets={'fields': 'FIELDS','headers':'HEADERS', 'appendix':'APPENDIX'}):
    ...
    def generatePaintedImport(self):
        return ''
    
    #convert multiple hank.ai jobs into a single painted import file
    def generatePaintedImportBATCH(self, jsonstringlist):
        return {}
...
if 1:
    ...
    iface.loadPaintedSpec(xlsfilepath=paintedspecfp)
    ...
    outdict = iface.generatePaintedImportBATCH(jsonstringlist=jsonstrings)
